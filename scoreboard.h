...
public:
    ...
    static void addToScore( uint8_t value ) {
        addToScore( static_cast<uint16_t>( value ) );
    }
...
private:
    static const uint8_t SCOREBOARD_ADDR;
    static const uint8_t SCORE_LOWERBYTE_ADDR;
    static const uint8_t SCORE_UPPERBYTE_ADDR;
    static const uint8_t STOP_BYTE;

    static volatile uint8_t transmit_state_;
    static volatile uint16_t score_;
